...
export interface ScrollExpandProps {
  ...
  title?: string;
  /** Cue under the resting frame that fades the moment scrolling starts. */
  scrollHint?: string;
  /** Frame size before expanding, as a percentage of the stage. */
  startWidth?: number;
  startHeight?: number;
  startRadius?: number;
  endRadius?: number;
  /** Zoom at rest; eases back to 1 as the frame opens. */
  mediaZoom?: number;
  /** Scroll length of the expansion, in multiples of the stage height. */
  scrollDistance?: number;
  /** Extra scroll the frame stays pinned at full bleed. */
  holdDistance?: number;
  /** Follow time in seconds; 0 locks the frame to the scrollbar. */
  smoothing?: number;
  overlayScrim?: number;
  /** Drive from the page scroll rather than the component's own scroller. */
...
export default function ScrollExpand({
  ...
  // Live prop mirror, so the scroll loop never has to be torn down and rebuilt
